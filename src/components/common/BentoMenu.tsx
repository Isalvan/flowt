...
export const BentoMenu: React.FC = () => {
  ...
  return (
    <div className="relative" ref={menuRef}>
      ...
      >
        <img src="http://localhost:5173/img/aether.png" alt="Aether Hub" className="w-6 h-6 object-contain rounded-full p-[2px] dark:bg-[#ffffff] dark:shadow-sm" />
      </button>
      ...
      {isOpen && (
        <div className="absolute top-12 right-0 w-72 p-4 rounded-3xl backdrop-blur-2xl bg-white/98 dark:bg-slate-900/90 border border-slate-200 dark:border-white/10 shadow-[0_12px_40px_rgba(15,23,42,0.16)] dark:shadow-2xl z-50 animate-in fade-in slide-in-from-top-4 duration-200">
          ...
          <div className="grid grid-cols-3 gap-3">
            <a href="http://localhost:5173" className="flex flex-col items-center gap-2 p-3 rounded-2xl bg-[rgba(247,249,255,0.95)] dark:bg-transparent border border-[rgba(100,120,160,0.12)] dark:border-transparent hover:bg-slate-100 dark:hover:bg-slate-800 transition-all group">
              <div className="w-12 h-12 rounded-xl bg-white dark:bg-slate-800 shadow-[0_5px_14px_rgba(50,65,100,0.10)] dark:shadow-none flex items-center justify-center group-hover:scale-110 transition-transform">
                <img src="http://localhost:5173/img/aether.png" alt="Aether" className="w-8 h-8 object-contain rounded-full p-[2px] dark:bg-[#ffffff] dark:shadow-sm" />
              </div>
              <span className="text-[10px] font-bold text-slate-700 dark:text-slate-300">Aether</span>
            </a>
            <a href="http://localhost:5174" className="flex flex-col items-center gap-2 p-3 rounded-2xl bg-[rgba(91,124,250,0.10)] dark:bg-indigo-500/10 border border-[rgba(91,124,250,0.28)] dark:border-indigo-500/20 shadow-[0_8px_24px_rgba(91,124,250,0.12)] dark:shadow-none transition-all group">
            ...
            <a href="http://localhost:5175" className="flex flex-col items-center gap-2 p-3 rounded-2xl bg-[rgba(247,249,255,0.95)] dark:bg-transparent border border-[rgba(100,120,160,0.12)] dark:border-transparent hover:bg-slate-100 dark:hover:bg-slate-800 transition-all group">
              <div className="w-12 h-12 rounded-xl bg-white dark:bg-slate-800 shadow-[0_5px_14px_rgba(50,65,100,0.10)] dark:shadow-none flex items-center justify-center group-hover:scale-110 transition-transform">
                <img src="http://localhost:5175/zenithfit-logo.png" alt="Zenith" className="w-8 h-8 object-contain" style={{ filter: 'drop-shadow(0 0 5px rgba(0,238,255,0.5))' }} />
              </div>
